...
<template>
  <div class="container px-5 md:px-[9.375rem]">
    ...
    >
      ...
      <div class="flex flex-col lg:col-span-2 gap-8 md:order-2">
        ...
        <a
          ...
          class="text-lighestgrey text-sm lg:text-base font-medium"
          >School of Product</a
        >
        <a
          href="/schools/data"
      ...
      <div class="flex flex-col lg:col-span-3 gap-8 md:order-1">
        ...
        <a
          ...
          >About</a
        >
        <a href="/#" class="text-lighestgrey text-sm lg:text-base font-medium"
          >Blog</a
        >
        <a
          href="/faqs"
      ...
      <div class="flex flex-col lg:col-span-1 gap-8 md:order-3">
        <header class="font-bold md:text-lg text-base">CONTACT</header>
        <a href="mailto:axiaafrica@gmail.com" class="text-sm font-medium block"
    ...
    <p class="w-full text-center mt-16 md:mt-32">
