<template>
  <section id="onboard" class="py-12 md:py-28">
    <div class="container px-5 lg:px-[9.375rem] space-y-12 md:space-y-20">
      <h4 class="font-medium text-[1.75rem] md:text-4xl text-darkish">
        Get onboard with us
      </h4>
      ...
      >
        ...
        />
        <div class="space-y-10 text-darkish">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            class="w-10 sm:w-14 text-darkish"
          >
            <path
          ...
          <p>
            ...
            of age, literacy, and location. <br />
            <br />
      ...
      <div class="space-y-6">
        <header
          class="font-medium text-[1.75rem] md:text-4xl text-darkish relative ml-24 before:absolute before:-left-24 before:w-20 before:h-1 before:bg-darkish before:top-1/2"
        >
          Why choose us
        </header>
        <p class="text-darkish font-medium">
